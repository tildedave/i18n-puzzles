...
if __name__ == "__main__":
    ...
    while lines:
        ...
        source_ts = timezone(first_tz).localize(
            datetime.strptime(first_timestamp, "%b %d, %Y, %H:%M")
        )
        dest_ts = timezone(second_tz).localize(
            datetime.strptime(second_timestamp, "%b %d, %Y, %H:%M")
        )
